...
export default function StateGovtPortal() {
  ...
  const [chatMsgs,    setChatMsgs]   = useState([{ role:'assistant', text:'Hi! 👋 I\'m your SkillsnJobs AI assistant. Ask me about schemes, skill data, certifications, or policy.' }]);
    ...
    <>
      ...
      <div className="sg-shell">
        ...
        <div style={{ position:'fixed', bottom:24, right:24, zIndex:10001, display:'flex', flexDirection:'column', alignItems:'flex-end' }}>
          {chatOpen && (
            <div style={{ width:340, height:460, background:'#fff', borderRadius:16, boxShadow:'0 8px 40px rgba(0,0,0,0.18)', border:'1px solid #E0E6EF', display:'flex', flexDirection:'column', marginBottom:10, overflow:'hidden' }}>
              ...
              <div style={{ padding:'6px 10px', display:'flex', gap:6, overflowX:'auto', borderTop:'1px solid #F1F5F9' }}>
                {['Skill schemes','Certification data','District reports','Policy queries'].map(s => (
              ...
              <div style={{ padding:'10px 12px', borderTop:'1px solid #E0E6EF', display:'flex', gap:8, alignItems:'center' }}>
                ...
                <button onClick={sendChatMessage} disabled={chatLoading || !chatInput.trim()}
                  style={{ width:34, height:34, borderRadius:'50%', background:chatInput.trim() ? '#1e3a5f' : '#E0E6EF', border:'none', cursor:'pointer',
          ...
          <button onClick={() => setChatOpen(o => !o)} style={{ width:52, height:52, borderRadius:'50%', background:'linear-gradient(135deg,#7B5CF6,#1e3a5f)', border:'none', cursor:'pointer', boxShadow:'0 4px 20px rgba(123,92,246,0.5)', display:'flex', alignItems:'center', justifyContent:'center', fontSize:22, position:'relative' }}>
            {chatOpen ? '✕' : '🤖'}
