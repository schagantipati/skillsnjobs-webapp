...
export default function SuperadminSetup() {
  ...
  const items = [
    { icon: '🎯', title: 'Target Beneficiaries', desc: 'Manage beneficiary groups — Women, SC/ST, Youth, PWD, Migrants and more — used to tag programmes and reports.', to: '/superadmin/setup/target-beneficiaries' },
    { icon: '🗺️', title: 'Geographic Coverage', desc: 'Define coverage dimensions — states, districts, rural/urban/tribal reach — used on partner profiles.', to: '/superadmin/setup/geographic-coverage' },
