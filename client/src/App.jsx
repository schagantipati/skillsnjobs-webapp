...
// Eagerly load pages that are shown before auth resolves
import Login from './pages/Login.jsx';
import LandingPage from './pages/LandingPage.jsx';

// Lazy-load all portal and secondary pages — biggest bundle win
...
const TrainingVendorPortal  = lazy(() => import('./pages/TrainingVendorPortal.jsx'));
const CandidatePortal       = lazy(() => import('./pages/CandidatePortal.jsx'));
const TrainerPortal         = lazy(() => import('./pages/TrainerPortal.jsx'));
const PlacementPartnerPortal= lazy(() => import('./pages/PlacementPartnerPortal.jsx'));
const CsrOrganizationPortal = lazy(() => import('./pages/CsrOrganizationPortal.jsx'));
const EmployerPortal        = lazy(() => import('./pages/EmployerPortal.jsx'));
const StateGovtPortal       = lazy(() => import('./pages/StateGovtPortal.jsx'));
